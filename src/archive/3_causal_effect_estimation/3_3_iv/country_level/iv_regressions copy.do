...
local indir  "/Users/luciasauer/Library/CloudStorage/GoogleDrive-lucia.sauer@bse.eu/Mi unidad/EconAI/1_agreements_violence/agreements_violence/data/output/country_level"
local outdir "/Users/luciasauer/Library/CloudStorage/GoogleDrive-lucia.sauer@bse.eu/Mi unidad/EconAI/1_agreements_violence/agreements_violence/src/4_results/iv_regressions"
...
*******************************************************************
* 4.1. NSTRUMENT SET 1: Regional/Subregional spillovers (monthly lag 1 month)
*******************************************************************

* Instruments
local z1_1 "agree_region_excl_w_trade"
local z2_1 "agree_subreg_excl_w_trade"
local z3_1 "agree_region_excl_w_dist"
local z4_1 "agree_subreg_excl_w_dist"

* Create 1-month lags if available
foreach v in `z1_1' `z2_1' `z3_1' `z4_1' {
    gen L1_`v' = L1.`v'
}

* FIRST STAGE + IV for z1_1

xtreg `treatment' L1_`z1_1' `controls' if year>=`tmin' & year<=`tmax' & influence > 0, fe vce(cluster countryid)
test L1_`z1_1'
outreg2 using "`fs_out'", append excel bdec(3) sdec(3) label addstat("F-stat", r(F)) ///
	addtext("Instrument","`z1_1'","Set","1_1")

xtivreg `y' (`treatment' = L1_`z1_1') `controls' if year>=`tmin' & year<=`tmax' & influence > 0 & best_prevm>0, fe vce(cluster countryid)
outreg2 using "`iv_out'", append excel bdec(3) sdec(3) label ///
	addtext("Instrument","L1_`z1_1'","Set","1_1","Endog","`treatment'","Outcome","`y'")

* FIRST STAGE + IV for z2_1

xtreg `treatment' L1_`z2_1' `controls' if year>=`tmin' & year<=`tmax' & influence > 0, fe vce(cluster countryid)
test L1_`z2_1'
outreg2 using "`fs_out'", append excel bdec(3) sdec(3) label addstat("F-stat", r(F)) ///
	addtext("Instrument","L1_`z2_1'","Set","1_1")

xtivreg `y' (`treatment' = L1_`z2_1') `controls' if year>=`tmin' & year<=`tmax' & influence > 0 & best_prevm>0, fe vce(cluster countryid)
outreg2 using "`iv_out'", append excel bdec(3) sdec(3) label ///
	addtext("Instrument","L1_`z2_1'","Set","1_1","Endog","`treatment'","Outcome","`y'")


* FIRST STAGE + IV for z3_1
	
xtreg `treatment' L1_`z3_1' `controls' if year>=`tmin' & year<=`tmax' & influence > 0, fe vce(cluster countryid)
test L1_`z3_1'
outreg2 using "`fs_out'", append excel bdec(3) sdec(3) label addstat("F-stat", r(F)) ///
	addtext("Instrument","L1_`z3_1'","Set","1_1")

xtivreg `y' (`treatment' = L1_`z3_1') `controls' if year>=`tmin' & year<=`tmax' & influence > 0 & best_prevm>0, fe vce(cluster countryid)
outreg2 using "`iv_out'", append excel bdec(3) sdec(3) label ///
	addtext("Instrument","L1_`z3_1'","Set","1_1","Endog","`treatment'","Outcome","`y'")

* FIRST STAGE + IV for z4_1
	
xtreg `treatment' L1_`z4_1' `controls' if year>=`tmin' & year<=`tmax' & influence > 0, fe vce(cluster countryid)
test L1_`z4_1'
outreg2 using "`fs_out'", append excel bdec(3) sdec(3) label addstat("F-stat", r(F)) ///
	addtext("Instrument","L1_`z4_1'","Set","1_1")

xtivreg `y' (`treatment' = L1_`z4_1') `controls' if year>=`tmin' & year<=`tmax' & influence > 0 & best_prevm>0, fe vce(cluster countryid)
outreg2 using "`iv_out'", append excel bdec(3) sdec(3) label ///
	addtext("Instrument","L1_`z4_1'","Set","1_1","Endog","`treatment'","Outcome","`y'")
