...
*local treatment "agreement_active"
...
local indir  "/Users/luciasauer/Library/CloudStorage/GoogleDrive-lucia.sauer@bse.eu/Mi unidad/EconAI/1_agreements_violence/agreements_violence/data/output/conflict_level/windows"
local outdir "/Users/luciasauer/Library/CloudStorage/GoogleDrive-lucia.sauer@bse.eu/Mi unidad/EconAI/1_agreements_violence/agreements_violence/src/4_results/event_study/conflict_level/`matching_method'_matching"
...
graph export "`outdir'/`treatment'/`buffer_treated_size'/eventstudy_mechanisms.png", as(png) replace
...
csdid_plot, group(`grp') ///
    ytitle(`"`ytitle_main'"') xtitle("Quarters to peace agreement") ///
